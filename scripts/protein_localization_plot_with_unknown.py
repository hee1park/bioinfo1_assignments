...
ax.scatter(log2_clip[no_loc], log2_rden[no_loc], alpha=0.5, s=10, 
...
plt.tight_layout()
plt.savefig('results/protein_localization_plot_with_unknown.png', dpi=150)
print("Figure saved to results/protein_localization_plot_with_unknown.png")